...
def LLMKeyphraseClustering(features, documents, num_clusters, prompt, text_type, encoder_model=None, prompt_for_encoder="Represent keyphrases for topic classification:", cache_file=None):
