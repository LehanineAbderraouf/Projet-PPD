...
from few_shot_clustering.active_semi_supervised_clustering.active_semi_clustering.semi_supervised.pairwise_constraints import select_keyphrase_expansion_prompt
...
def load_tweet(data_path, cache_path = None, encoder="distilbert"):
    ...
    text_type = "Tweet"
    keyphrase_prompt = select_keyphrase_expansion_prompt("tweet")

    return embeddings, list(data['cluster']), list(data['text']), keyphrase_prompt, prompt_suffix, text_type
...
def load_clinc(cache_path = None, encoder="instructor"):
    ...
    text_type = "Query"
    keyphrase_prompt = select_keyphrase_expansion_prompt("clinc")

    return embeddings, remapped_intents, list(filtered_texts), keyphrase_prompt, prompt_suffix, text_type
...
def load_bank77(cache_path = None, encoder="instructor"):
    ...
    keyphrase_prompt=select_keyphrase_expansion_prompt("bank77")
    prompt_suffix = "express the same general intent?"
    text_type = "Query"

    return embeddings, labels, texts, keyphrase_prompt, prompt_suffix, text_type
